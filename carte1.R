...
N<-c(60, 70, 80, 90, 100)
Lm<-c(0.917, 1.25, 1.64,2.14, 2.69)
enrL<-data.frame(Lm, N)
#print(ggplot(enrL) + geom_point(aes(x = N, y = Lm)))
...
print(ggplot(enrL) + geom_point(aes(x = Lm, y = N), colour = "#4271AE")  + stat_function(fun = Nest_c1, color = "red") +  ggtitle("tours / inductance - carte 1")
      + geom_vline(xintercept=1.62, linetype="dashed", color = "red")
