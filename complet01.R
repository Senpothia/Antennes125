...
LEst<-function(N){1.332e-01  -5.725e-03 * N +   3.093e-04 * N^2}
...
REst<-function(N){45.977107  -1.702350 * N +   0.039540 * N^2}
...
curve(In, 0, 120, col="red", main="Courant estimé antenne Vs tours - global",  xlab="Tours",
      ylab="Iant(mA)")
)
#dev.off()
# 
