...
print(
      ...
      ggplot(TAB, color=c("Ln", "L1", "L2", "L3")) 
...
# Résistance et courant d'antenne sur neutre
 ...
 R0Est<-function(N){32.304  -1.2950 * N +   0.03608 * N^2}
 print(ggplot(TAB) + geom_point(aes(x = N, y = R1), colour = "#4271AE")  + stat_function(fun = R0Est, color = "red") +  ggtitle("Résistance ant / tours - Neutre")
